...
typedef enum {
    ...
    LV_EVENT_DOUBLE_CLICKED,      /**< Called for two short clicks within small distance and short time*/
    LV_EVENT_TRIPLE_CLICKED,      /**< Called for three short clicks within small distance and short time*/
